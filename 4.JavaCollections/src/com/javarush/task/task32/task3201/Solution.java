...
public class Solution{
    ...
    public static void main(String[] args) throws IOException {
        //String fileName = "G:\\RDNDJV\\JavaRushTasks\\4.JavaCollections\\src\\com\\javarush\\task\\task32\\task3201\\temp.txt";
        //long position = 10;
        //String text = "it is my text of file";
        String fileName = args[0];
        long position = Integer.parseInt(args[1]);
        String text = args[2];

        RandomAccessFile file = new RandomAccessFile(fileName, "rw");
        position = position < file.length() ? position : file.length();
        file.seek(position);
