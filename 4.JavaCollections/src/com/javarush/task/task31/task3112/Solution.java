...
public class Solution{
    public static Path downloadFile(String urlString, Path downloadLDirectory) throws IOException {
        ...
        Path destPath = Paths.get(downloadLDirectory.toString(), fileName);
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path passwords = downloadFile("https://yastatic.net/morda-logo/i/citylogos/yandex19-logo-ru.png", Paths.get("G:\\temp"));
